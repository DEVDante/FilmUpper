...
\title{FilmUpper - aplikacja poprawiająca jakość plików wideo}
...
\label{fig:MainInt}
\end{figure}
Interfejs prosi użytkownika o podanie pliku źródłowego oraz pliku docelowego (rysunek \ref{fig:MainInt}). W tym celu może on skorzystać z odpowiednich pól wpisując do nich ścieżki plików lub  korzystając z typowego okna wyboru pliku.
...
\bibitem{QtDoc} Qt 5.10 Documentation, http://doc.qt.io/qt-5/index.html [dostępne: 11.01.2018]
