...
Na rysunku \ref{fig:fpsInterlace} widać efekt podobny do tego, jaki został uzyskany przy zastosowaniu algorytmu interpolacji (rysunek \ref{fig:fpsIntBunny}), jednakże zamiast stopniowej zmiany wartości pikseli na nowe, zaktualizowane zostały tylko co drugie wiersze pikseli obrazu.
